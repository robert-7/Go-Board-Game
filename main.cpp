...
void jump_off(int x0, int z0, int color) {
    ...
    int x1 = -4;
    float xt = x0 * (1 - t) + x1 * t;
    int y0 = 9;
    float yt = -y0 * std::pow(t, 2.0F) + y0 * t + y0;
    int z1 = -4;
    float zt = z0 * (1 - t) + z1 * t;
    ...
    glPushMatrix();
    if (t < 0.1) {
        glRotatef(-80 + 80 * std::sin(t * 10.0F * PI), 1.0, 0.0, 1.0);
    } else {
    ...
    if (t < 0.1) {
        glRotatef(90 - 90 * std::sin(t * 10.0F * PI), 1.0, 0.0, 1.0);
    } else {
    ...
    glTranslatef(0, -1.0, 0);
    if (t < 0.1) {
        glRotatef(-100 + 100 * std::sin(t * 10.0F * PI), 1.0, 0.0, 1.0);
    } else {
